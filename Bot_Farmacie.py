...
def main():
    updater = Updater("1850712147:AAFiRuxxgyps1HhI3R2j0buYbj4m0kVcN8k")
...
cur.execute("select ST_AsGeoJSON(geom) from farmacie")    #ricava coordinate in GeoJSON
a = cur.fetchall()
cur.execute("select indirizzo from farmacie")    #ricava coordinate in GeoJSON
b = cur.fetchall()
cur.execute("select denominazi from farmacie")    #ricava coordinate in GeoJSON
c = cur.fetchall()
